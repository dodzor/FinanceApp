const StorageCtrl = (function(){
  ...
  const UICtrl = (function(){
    ...
    return {
      ...
      hideChart() {
        document.querySelector(UISelectors.chart).style.display = 'none';
      },
      showChart() {
        document.querySelector(UISelectors.chart).style.display = 'inline';
  ...
  const App = (function(ExpenseCtrl, UICtrl, StorageCtrl, HelperCtrl, ChartSingleton){
    ...
    const addExpense = function(e){
      ...
      if(description === '' || value === '' || category === '' || uniqueId == '') {
        ...
        // Show success
        UICtrl.showAlert('Category Added!', 'success');
    ...
    return {
      init: function(){
        ...
        if (expenses.length === 0) {
          ...
          // Hide chart because there is no data
        //   UICtrl.hideChart(); 
          UICtrl.hideList();
        }
        else {
